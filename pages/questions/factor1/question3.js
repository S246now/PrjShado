    ...
    return (
        <div className={classes.container}>
            <div className={classes.containerHijo}>
                <h1>Factor 1 - Tercera Pregunta</h1>
                ...
                <div>
                    ...
                    <label htmlFor="option1">
                        <audio src="/audio/factor1-3a.mp3" controls />
                    </label>
                </div>
                ...
                <div>
                    ...
                    <label htmlFor="option2">
                        <audio src="/audio/factor1-3b.mp3" controls />
                    </label>
                </div>
                ...
                <div>
                    ...
                    <label htmlFor="option3">
                        <audio src="/audio/factor1-3c.mp3" controls />
                    </label>
                </div>
                ...
                <div>
                    ...
                    <label htmlFor="option4">
                        <audio src="/audio/factor1-3d.mp3" controls />
                    </label>
                </div>
