...
function OptionsQ4({ onOptionSelected }) {
        ...
        <div>
            ...
            <div>
                ...
                <label htmlFor="option1">
                    {/* Opción 1 */}
                    <audio src="/audio/factor2-4a.mp3" type="audio/mp3" controls />
                </label>
            </div>
            ...
            <div>
                ...
                <label htmlFor="option2">
                    <audio src="/audio/factor2-4.mp3" type="audio/mp3" controls />
                </label>
            </div>
            ...
            <div>
                ...
                <label htmlFor="option3">
                    <audio src="/audio/factor2-4c.mp3" type="audio/mp3" controls />
                </label>
            </div>
            ...
            <div>
                ...
                <label htmlFor="option4">
                    <audio src="/audio/factor2-4d.mp3" controls />
                </label>
            </div>
