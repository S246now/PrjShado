    ...
    return (
        <div className={classes.container}>
            <div className={classes.containerHijo}>
                <h1>Factor 3 - Cuarta Pregunta</h1>
                ...
                <div>
                    ...
                    <label htmlFor="option1">
                        {/* Opción 1 */}
                        <audio src="/audio/factor3-4a.mp3" controls />
                    </label>
                </div>
                ...
                <div>
                    ...
                    <label htmlFor="option2">
                        <audio src="/audio/factor3-4b.mp3" controls />
                    </label>
                </div>
                ...
                <div>
                    ...
                    <label htmlFor="option3">
                        <audio src="/audio/factor3-4c.mp3" controls />
                    </label>
                </div>
                ...
                <div>
                    ...
                    <label htmlFor="option4">
                        <audio src="/audio/factor3-4d.mp3" controls />
                    </label>
                </div>
