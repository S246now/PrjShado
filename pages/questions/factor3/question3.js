...
function QuestionPage3() {
    ...
    useEffect(() => {
        if (timeRemaining === 0) {
            ...
            const path = "/questions/factor3/question4";
            router.push(path);
        }
    }, [timeRemaining]);
    ...
    return (
        <div className={classes.container}>
            <div className={classes.containerHijo}>
                <h1>Factor 3 - Tercera Pregunta</h1>
                ...
                <div>
                    ...
                    <label htmlFor="option1">
                        {/* Opción 1 */}
                        <audio src="/audio/factor3-3a.mp3" controls />
                    </label>
                </div>
                ...
                <div>
                    ...
                    <label htmlFor="option2">
                        <audio src="/audio/factor3-3b.mp3" controls />
                    </label>
                </div>
                ...
                <div>
                    ...
                    <label htmlFor="option3">
                        <audio src="/audio/factor3-3c.mp3" controls />
                    </label>
                </div>
                ...
                <div>
                    ...
                    <label htmlFor="option4">
                        <audio src="/audio/factor3-3d.mp3" controls />
                    </label>
                </div>
